...
const CHARACTERS = [
  ...
  },
  {
    ...
    secondary: {
      name: "Ohger Finish",
      desc: "ฟาดด้วยโอเจอร์คาลิเบอร์ — ใช้ไม่ได้จนกว่าจะเข้าเงื่อนไข: มีทั้ง สวมเกราะราชัน และ ประกายเขี้ยวปฏิปักษ์ หรือ มีประกายเขี้ยวปฏิปักษ์อย่างเดียว (2 กรณีที่ใช้ได้) เมื่อเข้าเงื่อนไขจะสร้างความเสียหายเพิ่ม +2 หน่วย (ทำงานหลังเปิดไพ่)",
      cost: 4,
