...
const CHARACTERS = [
  ...
  },
  {
    ...
    secondary: {
      name: "Ohger Finish",
      desc: "ฟาดด้วยโอเจอร์คาลิเบอร์ — ใช้ไม่ได้จนกว่าจะมีทั้ง สวมเกราะราชัน และ ประกายเขี้ยวปฏิปักษ์ พร้อมกัน เมื่อเข้าเงื่อนไขจะสร้างความเสียหายเพิ่ม +2 หน่วย (ทำงานหลังเปิดไพ่)",
      cost: 4,
