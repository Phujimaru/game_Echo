...
const CHARACTERS = [
  ...
  },
  {
    ...
    ultimate: {
      ...
      desc: "ใช้ได้ช่วงก่อนเปิดการ์ด: เสี่ยงโชค 50/50 (สกิลติดตัวเพิ่มโอกาสสำเร็จได้) — เสียแต้มสกิลทั้งหมดฟรี หรือ ได้บัฟเวลาทอง 3 เทิร์น: อัตราสำเร็จด้านบวก +10% (ซ้อนกับสกิลติดตัวได้), แต้มที่ใช้ของสกิลพื้นฐาน/สกิลรองลดครึ่งหนึ่ง, รีเซ็ตจำนวนใช้สกิลพื้นฐานกลับมาเต็ม และกดสกิลพื้นฐานซ้ำได้ในเทิร์นนั้นจนกว่าจำนวนใช้/แต้มจะหมด",
      cost: 6,
  ...
  },
  {
    ...
    secondary: {
      name: "หอกลองกินัส",
      desc: "ทำงานก่อนเปิดการ์ด: เพิ่มพลังโจมตี 1 หน่วย คงอยู่ 1 เทิร์น — และหลังเปิดการ์ด หากได้โจมตีเป้าหมายในเทิร์นนี้ มีโอกาส 20/80 (สำเร็จ/ล้มเหลว) ที่จะทำให้เป้าหมายจั่วการ์ดเพิ่มไม่ได้ในเทิร์นถัดมา — สกิลติดตัว 3 ทำงาน = โอกาสเพิ่มเป็น 50/50",
      cost: 4,
