...
const BASIC_DEBUFF_CLEAR = ["discord", "sleep", "kstun", "stun", "nodraw", "noskill", "aquapoison", "weak", "fragile", "spellburden", "oblada", "calamity", "hburn", "phenexBanUlt"];
...
const DEBUFF_KEYS = ["discord", "sleep", "kstun", "stun", "nodraw", "noskill", "sena",
  ...
  "oblada", "calamity", "hburn", "phenexBanUlt"];
...
function instantDeath(p) {
  ...
  if (p.characterId === "phenex" && !p.phenexReborn) {
    phenexRebirth(p);
    return;
  }
...
function doAttack(byId, targetId) {
  ...
  if (attacker.characterId === "tohno" && tohnoLevel >= 2) {
